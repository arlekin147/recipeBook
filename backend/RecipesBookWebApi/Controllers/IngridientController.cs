...
namespace RecipesBookWebApi.Controllers
{
    ...
    public class IngridientController : ControllerBase
    {
        ...
        [ExceptionFilterAttribute]
        [HttpPost("search")]
        public async Task<List<IngridientApiModel>> SearchIngridients(SearchIngridientApiModel searchIngridientApiModel)
        {
            return _mapper.Map<List<IngridientApiModel>>(await _ingridientService.SearchIngridients(_mapper.Map<SearchIngridientModel>(searchIngridientApiModel)));
        }
